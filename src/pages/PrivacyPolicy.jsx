      ...
      <section className="bg-white py-16 px-6 md:px-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">1. Information We Collect</h2>
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">2. How We Use Your Information</h2>
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">3. We Do Not Sell Your Information</h2>
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">4. Third-Party Services</h2>
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">5. Cookies</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">6. Data Security</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">7. Children's Privacy</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">8. Your Rights</h2>
            ...
            <div>
              <h2 className="font-black text-gray-900 text-2xl mb-4">9. Changes to This Policy</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <h2 className="font-black text-gray-900 text-2xl mb-4">10. Contact Us About Privacy</h2>
